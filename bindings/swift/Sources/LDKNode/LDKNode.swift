...
public protocol NodeProtocol : AnyObject {
    ...
    func closeChannel(userChannelId: UserChannelId, counterpartyNodeId: PublicKey, force: Bool) throws 
...
public class Node:
    ...
    public func closeChannel(userChannelId: UserChannelId, counterpartyNodeId: PublicKey, force: Bool) throws  {
        try 
    rustCallWithError(FfiConverterTypeNodeError.lift) {
...
public struct FfiConverterTypeNodeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NodeError {
        ...
        case 6: return .OfferCreationFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 7: return .PaymentSendingFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 8: return .ProbeSendingFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 9: return .ChannelCreationFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 10: return .ChannelClosingFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 11: return .ChannelConfigUpdateFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 12: return .PersistenceFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 13: return .FeerateEstimationUpdateFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 14: return .WalletOperationFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 15: return .OnchainTxSigningFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 16: return .MessageSigningFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 17: return .TxSyncFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 18: return .GossipUpdateFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 19: return .LiquidityRequestFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        ...
        case 21: return .InvalidSocketAddress(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 22: return .InvalidPublicKey(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 23: return .InvalidSecretKey(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 24: return .InvalidPaymentId(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 25: return .InvalidPaymentHash(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 26: return .InvalidPaymentPreimage(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 27: return .InvalidPaymentSecret(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 28: return .InvalidAmount(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 29: return .InvalidInvoice(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 30: return .InvalidOffer(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 31: return .InvalidChannelId(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 32: return .InvalidNetwork(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 33: return .DuplicatePayment(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 34: return .UnsupportedCurrency(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 35: return .InsufficientFunds(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 36: return .LiquiditySourceUnavailable(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 37: return .LiquidityFeeTooHigh(
            message: try FfiConverterString.read(from: &buf)
        )
...
public struct FfiConverterTypePaymentKind: FfiConverterRustBuffer {
    ...
    public static func write(_ value: PaymentKind, into buf: inout [UInt8]) {
        ...
        case let .bolt12(hash,preimage,secret):
            writeInt(&buf, Int32(4))
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_ldk_node_checksum_method_node_close_channel() != 27253) {
        return InitializationResult.apiChecksumMismatch
    }
